	...
	<?php
		...
		<?php
			foreach($urunler['query'] as $indirimli) {
				...
				$sablon_gonder->date_start		= $indirimli->date_start;
	...
	<?php } else { ?>
			<!-- Hata -->
			 <div id="onay_mesaj">
			 	<div class="onay_image sola"><img src="<?php echo site_resim();?>unlem.png" alt="<?php echo lang('messages_not_discount_products_title'); ?>" title="<?php echo lang('messages_not_discount_products_title'); ?>"></div>
			 	<div class="onay_aciklama sola" style="padding-top:40px;">
			 		<b><?php echo lang('messages_not_discount_products_title'); ?></b>
			 		<br /><?php echo lang('messages_not_discount_products_content'); ?>
		 		</div>
			 	<div class="clear"></div>
			 	<p class="onay_buton">
