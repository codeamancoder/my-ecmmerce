	...
	<?php } else { ?>
			<!-- Hata -->
			 <div id="onay_mesaj">
			 	...
			 	<div class="clear"></div>
			 	<p class="onay_buton">
			 		<a href="javascript:history.back();" title="<?php echo lang('messages_button_back'); ?>" class="buton"><span><img src="<?php echo site_resim();?>btn_img_geri.png" alt="<?php echo lang('messages_button_back'); ?>" />&nbsp;<?php echo lang('messages_button_back'); ?></span></a>
					<a class="buton" style="margin-left:10px;" href="<?php echo site_url(); ?>" title="<?php echo lang('messages_button_back_home'); ?>"><span><img src="<?php echo site_resim();?>btn_img_anasayfa.png" alt="<?php echo lang('messages_button_back_home'); ?>" />&nbsp;<?php echo lang('messages_button_back_home'); ?></span></a>
			 	</p>
			 </div>
			 <!-- Hata SON -->
	<?php } ?>
